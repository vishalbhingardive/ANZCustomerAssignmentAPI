...
namespace MyTraining1121AngularDemo.Migrations
{
    ...
    [Migration("20220725091442_UpdatedUserCustomer")]
    partial class UpdatedUserCustomer
    {
            ...
            modelBuilder.Entity("MyTraining1121AngularDemo.Customers.CustomerUsers", b =>
                {
                    ...
                    b.HasOne("MyTraining1121AngularDemo.Authorization.Users.User", "UserRef")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
