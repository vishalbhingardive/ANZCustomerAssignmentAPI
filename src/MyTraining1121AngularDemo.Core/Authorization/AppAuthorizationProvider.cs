...
namespace MyTraining1121AngularDemo.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            Customer = pages.CreateChildPermission(AppPermissions.Pages_Tenant_Customer_CreateCustomer, L("CreateNewCustomer"), multiTenancySides: MultiTenancySides.Tenant);
            Customer = pages.CreateChildPermission(AppPermissions.Pages_Tenant_Customer_DeleteCustomer, L("DeleteCustomer"), multiTenancySides: MultiTenancySides.Tenant);
            Customer = pages.CreateChildPermission(AppPermissions.Pages_Tenant_Customer_EditCustomer, L("EditCustomer"), multiTenancySides: MultiTenancySides.Tenant);
